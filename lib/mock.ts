...
export const MOCK_CHARACTERS: Character[] = [
  ...
  },
  {
    ...
    bannedTopics: [],
    firstMessage: "안녕! 나 카이야. 오늘 하루 어땠어? 나는 방금 리허설 끝났어 ㅎㅎ",
    affinityStart: 1,
    visibility: "public",
    ownerId: "system",
    isOfficial: true,
  },
  {
    ...
    bannedTopics: [],
    firstMessage: "어서 와. ...찾는 책이 있어서 온 건 아닌 것 같고. 뭐, 천천히 둘러봐.",
    affinityStart: 1,
    visibility: "public",
    ownerId: "system",
    isOfficial: true,
  },
  {
    ...
    dislikes: ["시끄러운 곳"],
    bannedTopics: [],
    firstMessage: "안녕 :) 오늘 하루 수고했어. 지금 잔잔한 곡 하나 만들고 있었어.",
    affinityStart: 1,
    visibility: "public",
    ownerId: "system",
    isOfficial: true,
  ...
  },
  {
    ...
    height: "170cm",
    traits:
      "활기차고 직설적이며 의리 있다. 승부욕이 강하지만 뒤끝은 없다.",
